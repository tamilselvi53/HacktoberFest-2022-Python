...
class Test(unittest.TestCase):
    ...
    def test_binary_search_test_a(self):
        "Normal Test 1"
        self.assertEqual(solution([11, 2, 3, 8, 13], 3), 2, "Test 1 Failed")

    def test_binary_search_test_b(self):
        "Normal Test 2"
        self.assertEqual(solution([1, 92, 23, 54, 5], 5), 4, "Test 2 Failed")

    def test_binary_search_test_c(self):
        "Normal Test 3"
        self.assertEqual(solution([1, 32, 33, 54, 5], 1), 0, "Test 3 Failed")

    def test_binary_search_test_d(self):
        "Normal Test 4"
        self.assertEqual(solution([11, 42, 63, 43, 51], 0), -1, "Test 4 Failed")

    def test_binary_search_test_e(self):
        "Normal Test 5"
        self.assertEqual(solution([13, 29, 34, 46, 57], 6), -1, "Test 5 Failed")
