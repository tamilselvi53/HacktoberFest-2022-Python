...
class Test(unittest.TestCase):
    ...
    def test_calculator_test_a(self):
        """Normal Test 1"""
        self.assertEqual(solution(123), 6, "Test 1 Failed")

    def test_calculator_test_b(self):
        """Normal Test 2"""
        self.assertEqual(solution(2358), 18, "Test 2 Failed")

    def test_calculator_test_c(self):
        """Normal Test 3"""
        self.assertEqual(solution(66666), 30, "Test 3 Failed")

    def test_calculator_test_d(self):
        """Normal Test 4"""
        self.assertEqual(solution(1), 1, "Test 4 Failed")
